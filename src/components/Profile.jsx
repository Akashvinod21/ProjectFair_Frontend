      ...
      <div className="shadow p-4 my-5 bg-light rounded" onMouseEnter={()=>setOpen(true)} onMouseLeave={()=>setOpen(false)}> 
        ...
        <Collapse in={open} >
          <div>
            ...
            <div className="mb-3 px-4">
              <input type="text" placeholder='LinkedIn' value={userDetails.linkedin} className='form-control bg-dark text-light' onChange={(e)=>setUserDetails({...userDetails,linkedin:e.target.value})}/>
            </div>
            <div className="mb-3 px-4">
